...
if( ! function_exists( 'newsmatic_top_header_social_part' ) ) :
    ...
    function newsmatic_top_header_social_part() {
      ?>
         <div class="social-icons-wrap" style="flex: 1; display: flex; justify-content: end; align-items: center;"><?php if( ND\newsmatic_get_customizer_option( 'top_header_social_option' ) ) newsmatic_customizer_social_icons(); ?></div>
      <?php
    }
    add_action( 'newsmatic_header__site_branding_section_hook', 'newsmatic_top_header_social_part', 10 );
 endif;
 ...
 if( ! function_exists( 'newsmatic_header_site_branding_part' ) ) :
     ...
     */
     function newsmatic_header_site_branding_part() {
         ?>
            <div class="site-branding" style="flex: 1; display: flex; justify-content: start; align-items: center;">
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
                    <img style="max-height: 3rem; max-width: 8rem; object-fit: contain;" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/prof_amr_logo.png" alt="Prof AMR Logo">
                </a>
                <?php
    ...
    add_action( 'newsmatic_header__site_branding_section_hook', 'newsmatic_header_site_branding_part', 5 );
 endif;
