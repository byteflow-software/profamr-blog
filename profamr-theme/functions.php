<?php
/**
 * Prof AMR functions and definitions
 *
...
// Incluir funções personalizadas do Prof AMR
require get_template_directory() . '/prof-amr-functions.php';
...
/**
 * Enfileira script de toggle na sidebar Wiki apenas em /wiki
 */
function theme_enqueue_sidebar_toggle() {
    // Carrega somente em URLs que contenham '/wiki'
    ...
    wp_enqueue_script(
        'sidebar-toggle',
        get_template_directory_uri() . '/js/sidebar-toggle.js',
        [],               // Sem dependência de jQuery
        NEWSMATIC_VERSION,
        true              // No footer
    );
}
add_action( 'wp_enqueue_scripts', 'theme_enqueue_sidebar_toggle' );
