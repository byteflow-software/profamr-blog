...
?>
	<footer id="colophon" class="site-footer dark_bk">
		<!-- Prof AMR Custom Footer Branding -->
		<div class="prof-amr-footer-brand" style="text-align: center; padding: 20px; background: var(--prof-amr-primary); color: white;">
			<h3 style="margin: 0; font-size: 1.5em;">Prof AMR</h3>
			<p style="margin: 5px 0 0 0; font-size: 0.9em;">Portal de Notícias e Informação</p>
		</div>
		<?php
			/**
